...
object GraphGenerator extends LazyLogging {
  ...
  /**
    ...
    *
    * @param args First parameter denotes the input file that was generated by the map-reduce job. The program will exit
  ...
  /**
    ...
    *
    * @param mapReduceOutputFile Path to the output generated by the map-reduce job.
    */
